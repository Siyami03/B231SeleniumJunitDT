...
public abstract class TestBase {
    ...
    public void sceenShotOfWebElement( WebElement webElement ){
    ...
    //Ekran goruntusunu extent rapora ekleme
    ...
    //Webelement ekran goruntusunu  extent rapora ekleme
    ...
    //JS Executor ile Webelemente scroll
    public void jsScrollToWebElement(WebElement element){
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].scrollIntoView(true)",element);
    }

    //JS Executor ile scrollEnd
    public void jsScrollEnd(){
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window.scrollTo(0,document.body.scrollHeight)");
    }

    //JS Executor ile scrollHome
    public void jsScrollHome(){
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window.scrollTo(0,-document.body.scrollHeight)");
    }

    //JS Executor ile sendKeys()
