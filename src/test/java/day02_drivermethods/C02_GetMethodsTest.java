...
public class C02_GetMethodsTest {
    public static void main(String[] args) {
        ...
        if(actualTitle.contains("IT")){   System.out.println("TEST PASSED");  }
        ...
        if(actualUrl.contains("education")){  System.out.println("TEST PASSED");   }
        else {  System.out.println("TEST FAILED");    }
        ...
        if(htmlKod.contains("IT Programs")){   System.out.println("TEST PASSED"); }
        else {   System.out.println("TEST FAILED");       }
