...
public class C02_ExplicitWait_WebDriverWait extends TestBase {
        ...
        2)  Explicit Wait
            ...
            a) WebDriverWait :
            ==> Bir websayfasi yuklendikten sonra bir webelement ile ilgili specific bir KOSUL(==>ExpectedConditions)
            icin maximum belirtmis oldugumuz sure kadar bekletiriz ve bu sure default olarak yarim saniyelik araliklar
            ile olur
            ==> Bir kosulun gerceklesmesi farkli surelerde meydana gelebilir, böyle bir durumda Thread.sleep kullanmak
            Profosyonel bir yaklasim olmaz. Bunun yerine WebdriverWait ile bir webelementin olusmasini beklemek daha
            mantikli olur

            b) FluenWait:
            ==>Bir websayfasi yuklendikten sonra bir webelement ile ilgili specific bir KOSUL(==>ExpectedConditions)
            bizim belirteceğimz araliklar ile bekler         */
