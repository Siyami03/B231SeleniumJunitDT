...
public class C04_WindowHandle extends TestBase {
            ...
            /*Acilmis olan tum pencerelerin window handle degerlerini getWindowHandles() method ile aldik. Bu method bize
            Set return eder, ancak setlerde index kullanarak istedigimiz bir elemani secmek mumkun degildir. Bu nedenle
            bizde bu seti kullanarak bir tane List olusturduk. Listlerde get methodu sayesinde index ile istedigimiz
            pencereye rahat gecis yapabiliriz           */
