...
public class C02_ReadExcel {
        ...
        System.out.println("Satir sayisi = " + workbook.getSheet("Sheet1").getPhysicalNumberOfRows());
        ...
        System.out.println("Son satırın indexi = " + workbook.getSheet("Sheet1").getLastRowNum());
